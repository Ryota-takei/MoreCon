...
export const ImageTrimmingModal: VFC<Props> = (props: Props) => {
      ...
      <Modal isOpen={props.isOpen} onClose={wrapperOnClose}>
        ...
        >
          <ModalHeader textAlign="center" mt="2">
            <Text fontSize="18px" >プロフィール画像の選択/編集</Text>
          </ModalHeader>
          <ModalBody
            css={css`
          ...
          >
            {src ? (
              ...
              <label htmlFor="profile_image">
                <Center bg="gray.200"_hover={{cursor: "pointer"}} h="400px" borderRadius="10px">
                  <Input
                    type="file"
                    accept="image/*"
                    display="none"
          ...
          <ModalFooter>
            ...
            <Button size="sm" colorScheme="blue" onClick={onDone}>
              確定
            </Button>
          </ModalFooter>
        </ModalContent>
